...
from fabric.api import env, local,settings,run,abort
from fabric.contrib.console import confirm
import random

REPO_URL = 'https://github.com/rahvar/django-list-app.git'  
...
def _create_directory_structure_if_necessary(site_folder,warn_only=True):
